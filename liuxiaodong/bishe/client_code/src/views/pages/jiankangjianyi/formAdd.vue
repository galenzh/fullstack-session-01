			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="建议内容" prop="jianyineirong">
						<editor class="list_editor" :value="form.jianyineirong" placeholder="请输入建议内容" :readonly="!isAdd||disabledForm.jianyineirong?true:false"
							@change="(e)=>editorChange(e,'jianyineirong')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.jianyineirong = res.data.data.jianyineirong.replace(reg,'../../../pdas/file');
