	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">格式(1:文字，2:图片)</div>
					<div  class="info_text" >{{detail.format}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">消息已读(0:未读，1:已读)</div>
					<div  class="info_text" >{{detail.isRead}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('chat_message','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('chat_message','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
