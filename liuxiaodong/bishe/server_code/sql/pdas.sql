...
INSERT INTO `exampaper` (`id`, `addtime`, `name`, `time`, `status`) VALUES (4, '2025-04-13 12:57:27', 'Big Five人格测试', 25, '0');
INSERT INTO `exampaper` (`id`, `addtime`, `name`, `time`, `status`) VALUES (5, '2025-04-13 12:57:27', 'PHQ-9抑郁筛查', 15, '可用');
INSERT INTO `exampaper` (`id`, `addtime`, `name`, `time`, `status`) VALUES (6, '2025-04-13 12:57:27', 'GAD-7焦虑自评', 10, '可用');
COMMIT;
...
CREATE TABLE `examrecord` (
  ...
  `userid` bigint NOT NULL COMMENT '用户id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=731 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='考试记录';

-- ----------------------------
-- Records of examrecord
-- ----------------------------
BEGIN;
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (701, '2025-04-16 11:49:20', '姓名10', 1, '心理测评', 5, '你是否经常感到情绪极端波动，时而感到高兴，时而感到非常沮丧，且没有明显的原因？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '情绪波动可能反映了情感不稳定的倾向，可能与人格障碍相关。', 0, 'A', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (702, '2025-04-16 11:49:20', '姓名10', 1, '心理测评', 10, '你是否对自己的感受和行为缺乏自我控制，经常无法按计划行事或解决问题？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '缺乏自控可能是边缘型人格障碍或冲动型人格障碍的表现。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (703, '2025-04-16 11:49:20', '姓名10', 1, '心理测评', 7, '你是否经常不顾后果地做事，比如在没有考虑后果的情况下进行冲动消费、酗酒或做危险的行为？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '冲动行为可能反映了反社会或边缘型人格障碍。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (704, '2025-04-16 11:49:20', '姓名10', 1, '心理测评', 8, '你是否常常对他人的动机或行为抱有怀疑，认为他们总是试图伤害或利用你？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '这种怀疑可能与偏执型人格障碍有关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (705, '2025-04-16 11:49:20', '姓名10', 1, '心理测评', 6, '你是否在与他人关系中常常感到极度不安，害怕被抛弃或被拒绝？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '这种情感不安可能是边缘型人格障碍的特征。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (706, '2025-04-16 11:49:20', '姓名10', 1, '心理测评', 9, '你是否常常感到自己比别人优越，认为别人没有资格和你平等交往？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '过度的自我优越感可能与自恋型人格障碍相关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (707, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 13, '你是否容易对他人的批评产生过度反应，甚至可能表现出攻击性或敌对情绪？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '过度的情绪反应可能是边缘型人格障碍的表现。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (708, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 11, '你是否常常觉得与他人建立深层次关系是困难的，并且更喜欢保持与他人一定的距离？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '这种孤立感可能与回避型人格障碍相关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (709, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 14, '你是否在社交场合中常感到过于紧张，害怕被他人评价或拒绝？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '社交焦虑可能是社交恐惧症或回避型人格障碍的标志。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (710, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 12, '你是否经常对他人的情感反应不敏感，表现出冷漠或缺乏同理心？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '缺乏同理心是反社会人格障碍的常见特征。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (711, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 15, '你是否常常觉得自己无法体验到别人所说的幸福或满足，感到空虚或没有目标？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '空虚感可能与情感障碍或边缘型人格障碍相关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (712, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 16, '你是否经常在紧张和冲突的情况下表现出过度的愤怒或敌意？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '情绪失控可能与边缘型人格障碍有关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (713, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 18, '你是否感到生活中的规则和常规让你感到束缚，常常挑战现有的规则和社会规范？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '挑战规则可能与反社会人格障碍相关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (714, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 19, '你是否经常感到自己没有明确的生活目标或方向，不知道自己未来的道路是什么？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '缺乏方向感可能与情感障碍或边缘型人格障碍相关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (715, '2025-04-16 11:49:21', '姓名10', 1, '心理测评', 17, '你是否常常以为他人可能会背叛你或对你不忠，因此表现出过度的警觉性？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '过度的警觉性可能与偏执型人格障碍相关。', 0, '', 70);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (716, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 5, '你是否经常感到情绪极端波动，时而感到高兴，时而感到非常沮丧，且没有明显的原因？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '情绪波动可能反映了情感不稳定的倾向，可能与人格障碍相关。', 10, 'C', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (717, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 6, '你是否在与他人关系中常常感到极度不安，害怕被抛弃或被拒绝？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '这种情感不安可能是边缘型人格障碍的特征。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (718, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 7, '你是否经常不顾后果地做事，比如在没有考虑后果的情况下进行冲动消费、酗酒或做危险的行为？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '冲动行为可能反映了反社会或边缘型人格障碍。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (719, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 9, '你是否常常感到自己比别人优越，认为别人没有资格和你平等交往？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '过度的自我优越感可能与自恋型人格障碍相关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (720, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 10, '你是否对自己的感受和行为缺乏自我控制，经常无法按计划行事或解决问题？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '缺乏自控可能是边缘型人格障碍或冲动型人格障碍的表现。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (721, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 8, '你是否常常对他人的动机或行为抱有怀疑，认为他们总是试图伤害或利用你？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '这种怀疑可能与偏执型人格障碍有关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (722, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 11, '你是否常常觉得与他人建立深层次关系是困难的，并且更喜欢保持与他人一定的距离？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '这种孤立感可能与回避型人格障碍相关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (723, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 12, '你是否经常对他人的情感反应不敏感，表现出冷漠或缺乏同理心？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '缺乏同理心是反社会人格障碍的常见特征。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (724, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 13, '你是否容易对他人的批评产生过度反应，甚至可能表现出攻击性或敌对情绪？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '过度的情绪反应可能是边缘型人格障碍的表现。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (725, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 15, '你是否常常觉得自己无法体验到别人所说的幸福或满足，感到空虚或没有目标？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '空虚感可能与情感障碍或边缘型人格障碍相关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (726, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 14, '你是否在社交场合中常感到过于紧张，害怕被他人评价或拒绝？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '社交焦虑可能是社交恐惧症或回避型人格障碍的标志。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (727, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 16, '你是否经常在紧张和冲突的情况下表现出过度的愤怒或敌意？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '情绪失控可能与边缘型人格障碍有关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (728, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 17, '你是否常常以为他人可能会背叛你或对你不忠，因此表现出过度的警觉性？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '过度的警觉性可能与偏执型人格障碍相关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (729, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 18, '你是否感到生活中的规则和常规让你感到束缚，常常挑战现有的规则和社会规范？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '挑战规则可能与反社会人格障碍相关。', 0, '', 71);
INSERT INTO `examrecord` (`id`, `addtime`, `username`, `paperid`, `papername`, `questionid`, `questionname`, `type`, `ismark`, `options`, `score`, `answer`, `analysis`, `myscore`, `myanswer`, `userid`) VALUES (730, '2025-04-16 11:50:33', '姓名3', 1, '心理测评', 19, '你是否经常感到自己没有明确的生活目标或方向，不知道自己未来的道路是什么？', 1, 1, '[{\"text\":\"经常这样\",\"code\":\"A\"},{\"text\":\"偶尔这样\",\"code\":\"B\"},{\"text\":\"从不这样\",\"code\":\"C\"}]', 10, 'C', '缺乏方向感可能与情感障碍或边缘型人格障碍相关。', 0, '', 71);
COMMIT;
...
INSERT INTO `forum` (`id`, `addtime`, `title`, `content`, `parentid`, `userid`, `username`, `avatarurl`, `isdone`, `is_top`, `top_time`, `thumbsup_number`, `crazily_number`) VALUES (8, '2025-04-10 18:33:00', '测评报告显示我有回避型人格', '对社交感到抗拒，总是想逃避冲突，有没有人一样？', 0, 8, '匿名用户', 'file/forumAvatarurl8.jpg,file/forumAvatarurl9.jpg,file/forumAvatarurl10.jpg', '开放', 0, NULL, 9, 0);
...
INSERT INTO `gaopinggongju` (`id`, `addtime`, `gongjumingcheng`, `tupian`, `xiangqing`, `shiyongfangfa`, `price`, `discuss_number`) VALUES (3, '2025-04-08 12:00:00', '边缘型人格测试套件', 'file/gaopinggongjuTupian3.jpg,file/gaopinggongjuTupian4.jpg,file/gaopinggongjuTupian5.jpg', '针对边缘型人格的特征量身定制的测试题与解释方案。', '选择题测试+结果匹配反馈', 109.9, 3);
INSERT INTO `gaopinggongju` (`id`, `addtime`, `gongjumingcheng`, `tupian`, `xiangqing`, `shiyongfangfa`, `price`, `discuss_number`) VALUES (4, '2025-04-08 12:00:00', '心理测评报告解读助手', 'file/gaopinggongjuTupian3.jpg', '自动生成测评报告解读，配合咨询师使用效果更佳。', '上传测评结果，自动生成分析', 114.9, 4);
...
INSERT INTO `gaopinggongju` (`id`, `addtime`, `gongjumingcheng`, `tupian`, `xiangqing`, `shiyongfangfa`, `price`, `discuss_number`) VALUES (9, '2025-04-08 12:00:00', '青少年人格倾向测评工具', 'file/1744771207476.jpg', '适合青少年人格发展筛查，提供早期干预建议。', '青少年模式测试+图形化反馈', 139.9, 9);
INSERT INTO `gaopinggongju` (`id`, `addtime`, `gongjumingcheng`, `tupian`, `xiangqing`, `shiyongfangfa`, `price`, `discuss_number`) VALUES (10, '2025-04-08 12:00:00', '心理咨询会员专属工具箱', 'file/gaopinggongjuTupian8.jpg', '限会员使用，包含所有测评免费权限及课程购买优惠。', '登录会员账号后可一键启用所有功能', 144.9, 10);
COMMIT;
...
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (2, '2025-03-22 12:42:31', '边缘型人格障碍与治疗方法', 'file/kechengxinxiKechengtupian2.jpg', '边缘型人格管理', '探索边缘型人格障碍的症状及其治疗方法，课程涵盖情感波动管理、冲动控制技巧及社交技巧的提升。', '', '2025-03-22 12:42:31', 2, 3, '2025-04-15 17:46:11', 109.9, 12000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (3, '2025-03-22 12:42:31', '反社会人格障碍识别与应对', 'file/kechengxinxiKechengtupian3.jpg', '心理健康3', '课程专注于反社会人格障碍的识别与管理，包括认知行为疗法（CBT）在内的多种治疗方法。', '', '2025-03-22 12:42:31', 0, 2, '2025-03-22 12:42:31', 79.9, 9000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (4, '2025-03-22 12:42:31', '自恋型人格障碍的应对技巧', 'file/kechengxinxiKechengtupian1.jpg', '心理健康4', '本课程讲解如何识别和应对自恋型人格障碍，帮助学员更好地管理人际关系与情感需求。', '', '2025-03-22 12:42:31', 0, 0, '2025-04-13 19:37:03', 59.9, 5000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (5, '2025-03-22 12:42:31', '人格障碍与情感调节技巧', 'file/kechengxinxiKechengtupian2.jpg', '心理健康5', '通过学习情感调节技巧和认知行为疗法，学员将学会有效控制情感波动，减少冲动行为。', '', '2025-03-22 12:42:31', 0, 5, '2025-04-15 17:46:03', 119.9, 13000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (6, '2025-03-22 12:42:31', '治疗人格障碍的科学方法', 'file/kechengxinxiKechengtupian6.jpg', '心理健康6', '该课程介绍了现代治疗人格障碍的科学方法，尤其是通过心理治疗来应对人格障碍相关症状。', '', '2025-03-22 12:42:31', 0, 2, '2025-04-15 17:52:39', 89.9, 11000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (7, '2025-03-22 12:42:31', '回避型人格障碍的识别与治疗', 'file/kechengxinxiKechengtupian5.jpg', '心理健康7', '课程讲解回避型人格障碍的症状，帮助学员识别并采取有效的治疗方法以减轻焦虑与恐惧。', '', '2025-03-22 12:42:31', 0, 4, '2025-04-15 17:53:27', 89.9, 9500);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (8, '2025-03-22 12:42:31', '依赖型人格障碍的自我帮助策略', 'file/kechengxinxiKechengtupian3.jpg', '心理健康8', '本课程为依赖型人格障碍学员提供自我帮助策略，帮助他们培养独立性和自信心，减少情感依赖。', '', '2025-03-22 12:42:31', 1, 1, '2025-04-15 17:45:34', 99.9, 10000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (9, '2025-03-22 12:42:31', '反社会行为与心理治疗', 'file/kechengxinxiKechengtupian2.jpg', '心理健康9', '该课程专门讲解如何通过心理治疗减少反社会行为，帮助学员重建社会功能并改善人际关系。', '', '2025-03-22 12:42:31', 2, 0, '2025-04-15 17:45:25', 109.9, 12000);
INSERT INTO `kechengxinxi` (`id`, `addtime`, `kechengmingcheng`, `kechengtupian`, `kechengleixing`, `kechengjianjie`, `kechengshipin`, `fabushijian`, `storeup_number`, `discuss_number`, `clicktime`, `price`, `jf`) VALUES (10, '2025-03-22 12:42:31', '人格障碍的早期识别与干预', 'file/kechengxinxiKechengtupian1.jpg', '心理健康10', '学习如何在早期识别人格障碍症状，并采用有效的干预方法进行治疗。适合有心理健康问题的学员。', '', '2025-03-22 12:42:31', 3, 1, '2025-04-15 17:45:00', 79.9, 9000);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品订单';
...
CREATE TABLE `storeup` (
  ...
  `userid` bigint NOT NULL COMMENT '用户id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='我的收藏';
...
INSERT INTO `token` (`id`, `userid`, `username`, `tablename`, `role`, `token`, `addtime`, `expiratedtime`) VALUES (2, 1, 'admin', 'users', '管理员', 'kf9cvtzq602f6bzmid667t9qpxljpdmi', '2025-03-22 12:46:46', '2025-04-16 12:47:01');
INSERT INTO `token` (`id`, `userid`, `username`, `tablename`, `role`, `token`, `addtime`, `expiratedtime`) VALUES (3, 71, '咨询师账号1', 'zixunshi', '管理员', '6zd85oljqn9sfrprqaeshqguzq6ppr6i', '2025-03-22 12:48:03', '2025-04-16 12:09:14');
INSERT INTO `token` (`id`, `userid`, `username`, `tablename`, `role`, `token`, `addtime`, `expiratedtime`) VALUES (4, 70, '10', 'yonghu', '用户', '5l0rder3lj0g04jc9nnizy1uqdmu5dix', '2025-04-07 12:37:50', '2025-04-16 12:38:05');
...
INSERT INTO `token` (`id`, `userid`, `username`, `tablename`, `role`, `token`, `addtime`, `expiratedtime`) VALUES (7, 71, '11', 'yonghu', '用户', '6k5y2turf1hbq7vswhd72h4khjap8u6l', '2025-04-11 11:26:11', '2025-04-16 12:42:48');
...
INSERT INTO `yonghu` (`id`, `addtime`, `zhanghao`, `mima`, `xingming`, `xingbie`, `touxiang`, `nianling`, `shouji`, `email`, `jf`, `money`) VALUES (70, '2025-03-22 12:42:31', '10', '123456', '姓名10', '男', 'file/yonghuTouxiang10.jpg', 10, '198198811110', '1020200010@qq.com', 10079, 868.2);
...
INSERT INTO `zixunshi` (`id`, `addtime`, `zixunshizhanghao`, `mima`, `zixunshixingming`, `xingbie`, `touxiang`, `lianxifangshi`, `zizhirenzheng`, `thumbsup_number`, `crazily_number`, `storeup_number`, `sfsh`, `shhf`) VALUES (81, '2025-03-22 12:42:31', '11', '11', '李咨询师', '男', 'file/zixunshiTouxiang10.jpg', '198198811110', 'file/zixunshiZizhirenzheng10.jpg', 11, 11, 11, '是', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='咨询师预约';
