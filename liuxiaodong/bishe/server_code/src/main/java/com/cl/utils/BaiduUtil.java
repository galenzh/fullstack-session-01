...
public class BaiduUtil {
    ...
    public static final String ACCESS_KEY = "50N8GH58d5JjrhSwaVhtpFpw";
    public static final String ACCESS_SECRET_KEY = "P99xHvudQo8o435m5uDOKnh1VIUlosLr";
    ...
    public static String qfChat(String msg) {
        Qianfan qianfan = new Qianfan(com.baidubce.qianfan.core.auth.Auth.TYPE_OAUTH, ACCESS_KEY, ACCESS_SECRET_KEY);
        // 指定模型
