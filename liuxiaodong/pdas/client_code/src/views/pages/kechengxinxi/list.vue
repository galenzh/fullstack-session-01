			...
			<div class="data_box">
				<div class="data_view">
					<div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)" >
						<div class="data_img_box" v-if="item.kechengtupian && item.kechengtupian.substr(0,4)=='http'" @click.stop="preViewClick(item.kechengtupian)">
							<el-image class="data_img" :src="item.kechengtupian" fit="cover"></el-image>
						</div>
						<div class="data_img_box" v-else @click.stop="preViewClick($config.url+item.kechengtupian.split(',')[0])">
							<el-image class="data_img" :src="item.kechengtupian?$config.url + item.kechengtupian.split(',')[0]:''"
								fit="cover"></el-image>
						</div>
						<div class="data_content">
							<div class="data_title1">
								<span>{{item.kechengmingcheng}}</span>
							</div>
...
<script setup>
	...
	const getList = () => {
		...
		if (categoryIndex.value != -1) {
			params.kechengleixing = categoryList.value[categoryIndex.value]
		}
