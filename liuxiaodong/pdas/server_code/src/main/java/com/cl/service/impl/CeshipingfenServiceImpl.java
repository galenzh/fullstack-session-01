...
public class CeshipingfenServiceImpl extends ServiceImpl<CeshipingfenDao, CeshipingfenEntity> implements CeshipingfenService {
    ...
    @Override
    public List<Map<String, Object>> pingfenSectionStat(Map<String, Object> params, Wrapper<CeshipingfenEntity> wrapper) {
        return baseMapper.pingfenSectionStat(params, wrapper);
    }
